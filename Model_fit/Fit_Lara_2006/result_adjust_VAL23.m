...
lb_0=[100    10   0.1   1   0.1   1];
 ub_0=[3000  2000  1    5   0.2   5];
parametro_estimar=6;
options = optimoptions(@fmincon,'Algorithm','interior-point');
%[pp,ss0]=fminsearch(@Adjust_batch_VAL23,k00,[],data);
%[pp,ss0]=fmincon(@Adjust_batch_VAL23,k00,[],[],[],[],lb_0,ub_0,data);
%[pp,ss0_fmincon_W3110]=fmincon(@Adjust_batch_VAL23,k00,[],[],[],[],lb_0,ub_0,[],options,data);
[pp,ss0_fmincon_W3110]=gamultiobj(@Adjust_batch_VAL23,parametro_estimar,[],[],[],[],lb_0,ub_0,[],[]);
