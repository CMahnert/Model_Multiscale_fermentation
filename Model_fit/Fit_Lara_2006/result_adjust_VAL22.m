...
lb_0=[0  10   0.1   1.12   0.1   1];
ub_0=[10000  1000  1    4     0.2   4];

parametro_estimar=6;
options = optimoptions(@fmincon,'Algorithm','interior-point');
%[pp,ss0]=fminsearch(@Adjust_batch_VAL22,k00,[],data);
%[pp,ss0]=fmincon(@Adjust_batch_VAL22,k00,[],[],[],[],lb_0,ub_0,data);
%[pp,ss0_fmincon_W3110]=fmincon(@Adjust_batch_VAL22,k00,[],[],[],[],lb_0,ub_0,[],options,data);
[pp,ss0_fmincon_W3110]=gamultiobj(@Adjust_batch_VAL22,parametro_estimar,[],[],[],[],lb_0,ub_0,[],[]);
