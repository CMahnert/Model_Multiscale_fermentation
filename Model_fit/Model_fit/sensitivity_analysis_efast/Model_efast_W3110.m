...
%save Model_efast_W3110.mat;

%% CALCULATE Si AND STi for each resample (1,2,...,NR) [ranges]
[Si_W3110,Sti_W3110,rangeSi_W3110,rangeSti_W3110] = efast_sd(Y,OMi,MI,time_points,1)
% Calculate Coeff. of Var. for Si and STi for Viral load (variable 4). See
% online Supplement A.5 for details.
[CVsi_W3110 CVsti_W3110]=CVmethod(Si_W3110, rangeSi_W3110,Sti_W3110,rangeSti_W3110,1)
% T-test on Si and STi for Viral load (variable 4)
s_HIV = efast_ttest(Si_W3110,rangeSi_W3110,Sti_W3110,rangeSti_W3110,1:length(time_points),efast_var,1,y_var_label,0.05)