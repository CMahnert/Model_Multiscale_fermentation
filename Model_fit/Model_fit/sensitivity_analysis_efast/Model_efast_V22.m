...
save Model_efast_V22.mat;

%% CALCULATE Si AND STi for each resample (1,2,...,NR) [ranges]
[Si_V22,Sti_V22,rangeSi_V22,rangeSti_V22] = efast_sd(Y,OMi,MI,time_points,1)
% Calculate Coeff. of Var. for Si and STi for Viral load (variable 4). See
% online Supplement A.5 for details.
[CVsi_V22 CVsti_V22]=CVmethod(Si_V22, rangeSi_V22,Sti_V22,rangeSti_V22,1)
% T-test on Si and STi for Viral load (variable 4)
s_HIV = efast_ttest(Si_V22,rangeSi_V22,Sti_V22,rangeSti_V22,1:length(time_points),efast_var,1,y_var_label,0.05)